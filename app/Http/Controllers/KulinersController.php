...
class KulinersController extends Controller
{
    ...
    public function all(){
        $data_temp = Kuliner::orderBy("created_at", "desc")->get();
    ...
    public function search($search){
        $data_temp = Kuliner::where('judul', 'like', '%' . $search . '%')->orderBy("created_at", "desc")->get();
    ...
    {
        $data_temp = Kuliner::orderBy("created_at", "desc")->limit($limit)->get();
    ...
    public function orderby($order){
        $data_temp = Kuliner::orderBy("created_at", $order)->get();
    ...
    {
        $data = Kuliner::find($request->id_kuliner);
        if ($data->delete()) {
            return response()->json([
                "status" => "berhasil"
            ]);
